# ---------- Builder ----------
    ...
    ARG NEXT_PUBLIC_POSTMARK_API_KEY
    ARG NEXT_PUBLIC_POSTMARK_SERVER_TOKEN
    ...
    ENV NEXT_PUBLIC_POSTMARK_API_KEY=$NEXT_PUBLIC_POSTMARK_API_KEY
    ENV NEXT_PUBLIC_POSTMARK_SERVER_TOKEN=$NEXT_PUBLIC_POSTMARK_SERVER_TOKEN
