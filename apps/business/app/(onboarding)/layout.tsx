...
export default function OnboardingLayout({ children }: { children: React.ReactNode }) {
  ...
  const currentIndex = ONBOARDING_STEPS.indexOf(currentSlug as OnboardingStep);

  const title = STEP_TITLES[currentSlug as OnboardingStep] ?? "";
  const subtitle = STEP_SUBTITLES[currentSlug as OnboardingStep];
